...
const PHASE_TEXT: Localized<Record<PhaseSlug, PhaseText>> = {
  es: {
    ...
    lutea: {
      ...
      nutrition: 'El cuerpo metaboliza la progesterona y se prepara para el reinicio — estos alimentos acompañan ese trabajo.',
  ...
  en: {
    ...
    lutea: {
      ...
      nutrition: 'The body metabolizes progesterone and gets ready to reset — these foods support that work.',
